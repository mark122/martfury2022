...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'delivery'], function () {
            Route::get('', [
                'as'   => 'delivery.index',
                'uses' => 'DeliveryController@getIndex',
            ]);
            Route::post('get-timeslot', [
                'as'   => 'delivery.get_time_slot',
                'uses' => 'DeliveryController@getTimeSlot',
            ]);
            Route::post('get-slotdata', [
                'as'   => 'delivery.get_slot_data',
                'uses' => 'DeliveryController@getSlotData',
            ]);
            Route::any('save-timeslot', [
                'as'   => 'delivery.save_time_slot',
                'uses' => 'DeliveryController@saveTimeSlot',
            ]);
            Route::post('remove-timeslot', [
                'as'   => 'delivery.remove_slot',
                'uses' => 'DeliveryController@removeTimeSlot',
            ]);
        });
