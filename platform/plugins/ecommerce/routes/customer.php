...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers\Customers', 'middleware' => ['web', 'core']],
    function () {
        Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
            ...
            Route::any('order-approve/{id}', [
                'as'         => 'order-approve',
                'uses'       => 'PublicController@orderApprove',
                //'permission' => 'customers.index',
            ]);
            Route::any('order-cancel/{id}', [
                'as'         => 'order-cancel',
                'uses'       => 'PublicController@orderCancel',
                //'permission' => 'customers.index',
            ]);
            Route::post('subcon-discount', [
                'as'         => 'subcontractor.discount',
                'uses'       => 'CustomerController@saveDiscount',
                //'permission' => 'customers.index',
            ]);
            Route::any('subcontractor', [
                'as'         => 'subcontractor',
                'uses'       => 'CustomerController@subContractor',
                //'permission' => 'customers.index',
            ]);
            Route::any('site-ar-report', [
                'as'         => 'site.report',
                'uses'       => 'CustomerController@SiteReport',
                //'permission' => 'customers.index',
            ]);
            Route::any('corporate', [
                'as'         => 'corporate',
                'uses'       => 'CustomerController@corporate',
                //'permission' => 'customers.index',
            ]);
            Route::any('corporate-code', [
                'as'         => 'corporate.code',
                'uses'       => 'CorporateCodeController@index',
                //'permission' => 'customers.index',
            ]);
            Route::get('corporate-code/create', [
                'as'         => 'corporate.code.create',
                'uses'       => 'CorporateCodeController@create',
                //'permission' => 'customers.index',
            ]);
            Route::post('corporate-code/store', [
                'as'         => 'corporate.code.store',
                'uses'       => 'CorporateCodeController@store',
                //'permission' => 'customers.index',
            ]);
            Route::any('corporate-code/edit/{id}', [
                'as'         => 'corporate.code.edit',
                'uses'       => 'CorporateCodeController@edit',
                //'permission' => 'customers.index',
            ]);
            Route::post('corporate-code/update/{id}', [
                'as'         => 'corporate.code.update',
                'uses'       => 'CorporateCodeController@update',
                //'permission' => 'customers.index',
            ]);
...
if (defined('THEME_MODULE_SCREEN_NAME')) {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::group([
            ...
            Route::get('add-user', [
                'as'         => 'add.user',
                'uses'       => 'PublicController@addUser',
                //'permission' => 'customers.index',
            ]);
            Route::get('edit-user/{id}', [
                'as'         => 'edit.user',
                'uses'       => 'PublicController@editUser',
                //'permission' => 'customers.index',
            ]);
            Route::post('update-user/{id}', [
                'as'         => 'update.user',
                'uses'       => 'PublicController@updateUser',
                //'permission' => 'customers.index',
            ]);
            Route::any('change-status/{id}', [
                'as'         => 'change-status',
                'uses'       => 'PublicController@changeStatus',
                //'permission' => 'customers.index',
            ]);
            Route::any('order-approve/{id}', [
                'as'         => 'order-approve',
            ...
            Route::get('show-user', [
                'as'         => 'show.user',
                'uses'       => 'PublicController@showUser',
                //'permission' => 'customers.index',
            ]);
            Route::post('save-user', [
                'as'         => 'save.user',
                'uses'       => 'PublicController@saveUser',
                //'permission' => 'customers.index',
            ]);
            Route::post('avatar', [
                'as'   => 'avatar',
