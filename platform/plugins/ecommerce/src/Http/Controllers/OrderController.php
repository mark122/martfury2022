...
use Botble\Ecommerce\Tables\SubContractorOrderTable;
...
class OrderController extends BaseController
{
    ...
    public function subContractorOrder(SubContractorOrderTable $dataTable)
    {
        page_title()->setTitle(trans('plugins/ecommerce::order.menu'));

        return $dataTable->renderTable();
    }
    public function getCorporateOrder(CorporateOrderTable $dataTable)
    {
        page_title()->setTitle(trans('plugins/ecommerce::order.menu'));
