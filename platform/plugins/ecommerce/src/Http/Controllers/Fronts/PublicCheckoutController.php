...
use Botble\Payment\Services\Gateways\PayLaterService;
use Botble\Payment\Services\Gateways\PayPalPaymentService;
use Botble\Payment\Services\Gateways\SendCorporateApproval;
...
class PublicCheckoutController
{
    ...
    public function postCheckout(
        ...
        SendCorporateApproval $sendCorporateApproval,
...
//dd(array_values($request->input('shipping_method'))[0]);
        ...
        $o->deliverytime_id = $req->delivery_id;
        $o->delivery_date = $req->delivery_dt;
        $o->save();
...
//                        exit($checkoutUrl);
                ...
                case PaymentMethodEnum::COD:
                    ...
                    break;
                case PaymentMethodEnum::SendForCoporateApproval:
                    $paymentData['charge_id'] = $sendCorporateApproval->execute($request);
                    break;
                case PaymentMethodEnum::PAY_LATER:
                    $paymentData['charge_id'] = $payLaterService->execute($request);
                    break;
