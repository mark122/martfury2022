        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ->registerItem([
                    ...
                    'id'          => 'cms-plugins-ecommerce-delivery',
                    'priority'    => 2,
                    'parent_id'   => 'cms-plugins-ecommerce',
                    'name'        => 'Delivery Slot',
                    'icon'        => 'fa fa-shopping-cart',
                    'url'         => route('delivery.index'),
                    'permissions' => ['plugins.delivery'],
                ])
//                ->registerItem([
//                    'id'          => 'cms-plugins-ecommerce-corporate-customer',
//                    'priority'    => 180,
//                    'parent_id'   => 'cms-plugins-ecommerce',
//                    'name'        => 'Corporate',
//                    'icon'        => 'fa fa-users',
...
//                ])
                ->registerItem([
                    ...
                    'name'        => 'Corporate Code',
                    'icon'        => 'fa fa-trophy',
                    'url'         => route('corporate.code'),
                ])
                ->registerItem([
                    'id'          => 'cms-plugins-ecommerce-customer',
                    'priority'    => 190,
                    'parent_id'   => 'cms-plugins-ecommerce',
                    'name'        => 'Site A/R report',
                    'icon'        => 'fa fa-file',
                    'url'         => route('site.report'),
                ...
                ->registerItem([
                    'id'          => 'cms-plugins-ecommerce-subcontractor-order',
                    'priority'    => 22,
                    'parent_id'   => 'cms-plugins-ecommerce',
                    'name'        => 'SubContractorOrder',
                    'icon'        => 'fa fa-shopping-bag',
                    'url'         => route('subcontractor-order'),
                   // 'permissions' => ['subcontractor.order'],
                ])
                ...
                ->registerItem([
                    ...
                    'priority'    => 10,
                    'parent_id'   => 'cms-plugins-ecommerce',
                    'name'        => 'plugins/ecommerce::shipping.name',
                    'icon'        => 'fas fa-tasks',
                ...
                ->registerItem([
                    'id'          => 'cms-plugins-ecommerce-sub-contractor',
                    'priority'    => 17,
                    'parent_id'   => 'cms-plugins-ecommerce',
                    'name'        => 'SubContractor',
                    'icon'        => 'fa fa-users',
