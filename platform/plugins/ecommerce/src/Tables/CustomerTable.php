...
class CustomerTable extends TableAbstract
{
    ...
    public function ajax()
    {
        $data = $this->table
            ...
            ->editColumn('ranking', function ($item) {
                $ranking = 'User';

                switch ($item->ranking) {
                    case '1':
                        $ranking = 'Sub Contractor';
                        break;
                    case '2':
                        $ranking = 'Corporate';
                        break;
                    case '3':
                        $ranking = 'Site Approval';
                        break;
                    case '4':
                        $ranking = 'Site Representative';
                        break;
                }
                return $ranking;
            })
            ...
            ->editColumn('corporate_code', function ($item) {
                return clean($item->corporate_code);
            })
