...
{{--    <div class="container">--}}
        <form class="ps-form--account ps-tab-root" method="POST" action="{{ route('customer.save.user') }}">
            @csrf
            <div class="ps-form__content">
                <h4>{{ __('Register An Account') }}</h4>
                <div class="row center">
                    <div class="col-md-6">
                   <input type="radio" id="html" name="ranking" value="3" checked>
                        <label for="html"><b>Site Approval</b></label><br>
                    </div>
                    <div class="col-md-6">
                <input type="radio" id="css" name="ranking" value="4">
