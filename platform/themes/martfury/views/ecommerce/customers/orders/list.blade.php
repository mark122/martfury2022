                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td>
                                ...
                                @if((auth('customer')->user()->ranking) == 2 || (auth('customer')->user()->ranking) == 3)
                                <a class="ps-btn ps-btn--sm ps-btn--small" href="{{ route('customer.order-approve', $order->id) }}">{{ __('Approve') }}</a>
                                <a class="ps-btn ps-btn--sm ps-btn--small" href="{{ route('customer.order-cancel', $order->id) }}">{{ __('Reject') }}</a>
                                @endif
