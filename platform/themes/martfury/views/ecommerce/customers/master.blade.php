                    ...
                    <aside class="ps-widget--account-dashboard">
                        ...
                        <div class="ps-widget__content">
                            <ul>
                                ...
                                @if(auth('customer')->user()->ranking == 2)
                                <li @if (Route::currentRouteName() == 'customer.add.user') class="active" @endif><a href="{{ route('customer.add.user') }}"><i class="icon-user"></i> {{ __('Add User') }}</a></li>
                                <li @if (Route::currentRouteName() == 'customer.show.user'  || Route::currentRouteName() == 'customer.edit.user' ) class="active" @endif><a href="{{ route('customer.show.user') }}"><i class="icon-users"></i> {{ __('Show User Under Me') }}</a></li>
                                @endif
