    ...
    <div class="container">
        <form class="ps-form--account ps-tab-root" method="POST" action="{{ route('customer.register.post') }}">
            ...
            <div class="ps-form__content">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" name="corporate_code" id="corporate_code" autocomplete="corporate_code" placeholder="Corporate Code">
                    @if ($errors->has('corporate_code'))
                        <span class="text-danger">{{ $errors->first('corporate_code') }}</span>
                    @endif
                </div>
                <div class="form-group">
